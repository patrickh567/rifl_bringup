...
# source axi_clock_converter_0.tcl
# If there is no project opened, this script will create a
# project, but make sure you do not have an existing project
# <./vu47p_rifl/vu47p_rifl.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
  create_project vu47p_rifl vu47p_rifl -part xcvu47p-fsvh2892-3-e
...
if { $bCheckIPs == 1 } {
  set list_check_ips { xilinx.com:ip:axi_clock_converter:2.1 }
